  ...
  return (
    <div>
      <div className="w-full  border-2 bg-sky-900 text-white text-center py-44">
        ...
        <p className="mt-8">Contact us today and discuss, how we can develop a mutually beneficial and long term relationship!</p>
      </div>
      <section className="text-gray-600 body-font relative">
        <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
          <div
            className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 
          flex items-end justify-start relative bg-[url('/images/bg.avif')]"
          >
